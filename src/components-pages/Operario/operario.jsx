...
import './operario.css'
import Operarioimg from '../../images/operario.png'
...
const Operario = () => {
    return (
        <section id='operario'>
            <h2>Informações </h2>
            <div className="container operario-container">

                <div className="operario-card">
                    <div className="operario-image">
                        <img src={Operarioimg} alt='operario'/>
                    </div>
                </div>
