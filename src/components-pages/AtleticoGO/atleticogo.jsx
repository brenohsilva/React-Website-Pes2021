...
import './atleticogo.css'
import Atleticogoimg from '../../images/atletico_goianiense.png'
import {RiHome7Fill} from 'react-icons/ri'

const AtleticoGO = () => {
    return (
        <section id='atleticogo'>
            <h2>Informações </h2>
            <div className="container atleticogo-container">

                <div className="atleticogo-card">
                    <div className="atleticogo-image">
                        <img src={Atleticogoimg} alt='Atletico-GO'/>
                    </div>
                </div>
