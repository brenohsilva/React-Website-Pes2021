...
import Fluminenseimg from '../images/fluminense.png'
import {RiHome7Fill} from 'react-icons/ri'

const Fluminense = () => {
    return (
        <section id='fluminense'>
            <h2>Informações </h2>
            <div className="container fluminense-container">

                <div className="fluminense-card">
                    <div className="fluminense-image">
                        <img src={Fluminenseimg} alt='Fluminense'/>
                    </div>
                </div>
