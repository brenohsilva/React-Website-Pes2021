...
import './coritiba.css'
import Coritibaimg from '../../images/coritiba.png'
...
const Coritiba = () => {
    return (
        <section id='coritiba'>
            <h2>Informações </h2>
            <div className="container coritiba-container">

                <div className="coritiba-card">
                    <div className="coritiba-image">
                        <img src={Coritibaimg} alt='Coritiba'/>
                    </div>
                </div>
