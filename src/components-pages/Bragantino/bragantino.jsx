...
import './bragantino.css'
import Bragantinoimg from '../../images/bragantino.png'
import {RiHome7Fill} from 'react-icons/ri'

const Bragantino = () => {
    return (
        <section id='bragantino'>
            <h2>Informações </h2>
            <div className="container bragantino-container">

                <div className="bragantino-card">
                    <div className="bragantino-image">
                        <img src={Bragantinoimg} alt='Bragantino'/>
                    </div>
                </div>
