...
import './atleticomg.css'
import AtletigoMGimg from '../../images/atletico_mineiro.png'
import {RiHome7Fill} from 'react-icons/ri'

const Atleticomg = () => {
    return (
        <section id='atletigomg'>
            <h2>Informações </h2>
            <div className="container atleticomg-container">

                <div className="atleticomg-card">
                    <div className="atleticomg-image">
                        <img src={AtletigoMGimg} alt='Atletico-MG'/>
                    </div>
                </div>
