...
import './botafogo.css'
import Botafogoimg from '../../images/botafogo.png'
...
const Botafogo = () => {
    return (
        <section id='botafogo'>
            <h2>Informações </h2>
            <div className="container botafogo-container">

                <div className="botafogo-card">
                    <div className="botafogo-image">
                        <img src={Botafogoimg} alt='Botafogo'/>
                    </div>
                </div>
