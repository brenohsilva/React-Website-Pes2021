...
import './parana.css'
import Paranaimg from '../../images/parana.png'
...
const Parana = () => {
    return (
        <section id='parana'>
            <h2>Informações </h2>
            <div className="container parana-container">

                <div className="parana-card">
                    <div className="parana-image">
                        <img src={Paranaimg} alt='Parana'/>
                    </div>
                </div>
